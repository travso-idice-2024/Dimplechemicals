...
const Subscriptions = () => {
  return (
    <div className="subgrid-two-item grid-common grid-c5 flex flex-col justify-between">
        <div className="grid-c-title">
            <h3 className="grid-c-title-text">Leads Alot</h3>
        ...
        <div className="grid-c-title">
            <h3 className="grid-c-title-text">Leads Data Alot Employee (Per Day)</h3>
        </div>
