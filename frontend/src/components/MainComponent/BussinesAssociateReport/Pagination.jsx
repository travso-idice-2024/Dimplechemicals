  ...
  return (
    <div className="bg-bgData rounded-[8px] shadow-md shadow-black/5 text-white px-4 py-3 flex justify-center items-center space-x-2 mb-3">
          <button
            ...
            className="text-newtextdata bg-bgDataNew text-white px-3 py-1 rounded hover:bg-bgDataNew disabled:opacity-50"
          >
            Previous
          </button>
            ...
            (number) =>
              ...
              (number >= currentPage - 1 && number <= currentPage + 1) ? (
                <button
                  ...
                  className={`px-3 py-1 text-newtextdata rounded ${
                    number === currentPage
