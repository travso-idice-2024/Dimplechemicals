...
const AddRoleModal = ({ setAddUserModalOpen }) => {
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center">
      <div className="bg-white w-[650px] pt-0 pb-4 rounded-[6px] flex flex-col">
        ...
        <div className="mt-5 md:mt-9 px-4 grid grid-cols-1 md:grid-cols-2 gap-4 overflow-y-auto h-fit">
          ...
          <div>
            ...
            <select className="block w-full mb-2 font-medium rounded-[5px] border border-solid border-[#473b33] focus:border-[#473b33] dark:focus:border-[#473b33] px-3 py-2">
        ...
        <div className="flex items-end justify-end gap-2 px-4">
          <button className="bg-bgDataNew text-textdata text-white px-3 py-2 rounded mt-2 hover:bg-[#cb6f2ad9]">
            Add Assignment
          </button>
          <button
            className="mt-4 bg-gray-500 text-white text-textdata px-3 py-2 rounded hover:bg-gray-600"
