...
const SalesPersonAssign = () => {
  const [searchTerm, setSearchTerm] = useState("");
  // Load initial users from localStorage or use default list
  const [users, setUsers] = useState(() => {
    const storedUsers = localStorage.getItem("salesassignment");
    return storedUsers
  ...
  useEffect(() => {
    localStorage.setItem("salesassignment", JSON.stringify(users));
  }, [users]);
...
export default SalesPersonAssign;
