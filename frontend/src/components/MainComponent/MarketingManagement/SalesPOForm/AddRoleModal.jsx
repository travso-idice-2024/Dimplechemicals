  ...
  return (
    <div className="fixed inset-0 p-2 bg-black/50 flex items-center justify-center z-50">
      <div className="bg-white w-full md:w-[1100px] pt-0 pb-4 rounded-[6px] flex flex-col">
        ...
        <div className="mt-5 md:mt-9 px-4 grid grid-cols-1 md:grid-cols-4 gap-4 overflow-y-auto h-[350px] md:h-fit">
        ...
        <div className="flex items-end justify-end gap-2 px-4">
          ...
          <button
            className="mt-4 bg-gray-500 text-white px-3 text-textdata whitespace-nowrap py-2 rounded hover:bg-gray-600"
