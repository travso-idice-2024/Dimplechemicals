...
const AddProductModal = ({ setAddProductModalOpen ,handleSubmitAddProduct,
  formData,
  setFormData,
        handleChange,
        setFormErrors,
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center">
      <div className="bg-white w-[850px] pt-0 pb-4 rounded-[6px] flex flex-col">
        ...
        <div>
              ...
              />
              {formErrors.product_name && <p className="text-red-500 text-sm">{formErrors.product_name}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="block w-full mb-2 rounded-[5px] border border-solid border-[#473b33] focus:border-[#473b33] px-3 py-2"
              />
              {formErrors.HSN_code && <p className="text-red-500 text-sm">{formErrors.HSN_code}</p>}
            </div>
            ...
            <div className="col-span-2">
              ...
              ></textarea>
              {formErrors.product_description && <p className="text-red-500 text-sm">{formErrors.product_description}</p>}
            </div>
